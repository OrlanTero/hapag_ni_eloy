...
Public Class PromotionController
    ...
    Public Function CreatePromotion(ByVal promotion As Promotion) As Boolean
        Dim query As String = "INSERT INTO promotions (name, value, value_type, start_date, valid_until, date_created, description, image) " & _
                             "VALUES (@name, @value, @value_type, @start_date, @valid_until, @date_created, @description, @image)"
