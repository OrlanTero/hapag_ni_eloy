<%@ Page Language="VB" AutoEventWireup="false" CodeFile="StaffDashboard.aspx.vb" Inherits="Pages_Staff_StaffDashboard" %>
...
<body>
    <form id="Form1" runat="server">
        ...
        <div class="main">
                <span class="dot" style="background-color: #D12929; margin-right:80px;"></span>
                <span class="dot" style="background-color: #FFC233"></span>
                <span class="dot" style="background-color: #619F2B"></span>
