    ...
    Protected Sub Page_Load(ByVal sender As Object, ByVal e As System.EventArgs) Handles Me.Load
        If Not IsPostBack Then
            ...
            If IsReadOnlyMode() Then
                System.Diagnostics.Debug.WriteLine("AdminPromotions: Page is in read-only mode")
                SetPageToReadOnly()
                ShowViewOnlyNotice()
            ...
            Else
                System.Diagnostics.Debug.WriteLine("AdminPromotions: Page is in full access mode")
            End If
        End If
    End Sub
